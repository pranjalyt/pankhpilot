        ...
        <section className="py-20 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-4xl font-bold text-brand-navy mb-4">MEET THE CREW</h2>
                    <p className="text-gray-600">Learn from the best in the industry.</p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {crew.map((member, index) => (
                        <div key={index} className="bg-brand-light rounded-2xl p-8 text-center hover:shadow-lg transition-shadow">
                            ...
                            <Link to="/about" className="text-sm font-semibold text-brand-navy hover:text-brand-orange transition-colors">
                                View Full Profile
                            </Link>
                        </div>
                    ))}
